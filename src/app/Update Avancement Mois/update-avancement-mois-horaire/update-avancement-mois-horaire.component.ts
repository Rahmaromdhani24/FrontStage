...
@Component({
  selector: 'app-update-avancement-mois-horaire',
  templateUrl: './update-avancement-mois-horaire.component.html',
  styleUrls: ['./update-avancement-mois-horaire.component.css']
})
export class UpdateAvancementMoisHoraireComponent implements OnInit {
  ...
  annulation() {
    ...
    this.router.navigate(['/modifierAvancementsMoisHoraire']);
  }
