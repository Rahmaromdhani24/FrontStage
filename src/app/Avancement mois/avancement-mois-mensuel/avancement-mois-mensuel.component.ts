...
@Component({
  selector: 'app-avancement-mois-mensuel',
  templateUrl: './avancement-mois-mensuel.component.html',
  styleUrls: ['./avancement-mois-mensuel.component.css']
})
export class AvancementMoisMensuelComponent implements OnInit {
  ...
  annulation() {
    ...
    this.router.navigate(['/avancementMensuel']);
  }
