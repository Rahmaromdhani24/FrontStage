...
@Component({
  selector: 'app-avancement-personnel-horaire',
  templateUrl: './avancement-personnel-horaire.component.html',
  styleUrls: ['./avancement-personnel-horaire.component.css']
})
export class AvancementPersonnelHoraireComponent implements OnInit , AfterViewInit{
...
reinitializeDataTable(): void {
  ...
  selection(){
    this.router.navigate(['/avancementMoisHoraire'])
  }
  deconnexion(){
    localStorage.clear() ; 
