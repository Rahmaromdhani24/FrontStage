...
@Component({
  selector: 'app-personnel-horaire',
  templateUrl: './personnel-horaire.component.html',
  styleUrls: ['./personnel-horaire.component.css']
})
export class PersonnelHoraireComponent  implements OnInit ,AfterViewInit  {
  showLoader : boolean = true; 
  informationsPersonnel: any // Personnel | null = null; 


  navText = 'Personnel Horaire';
  ...
  getAllPersonnels() {
    this.service.getAllPersonnelsHoraire().subscribe((data: Personnel[]) => {
