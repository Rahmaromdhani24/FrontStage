...
@Component({
  selector: 'app-avancement-mensuel',
  templateUrl: './avancement-mensuel.component.html',
  styleUrls: ['./avancement-mensuel.component.css']
})
export class AvancementMensuelComponent implements OnInit , AfterViewInit{
...
reinitializeDataTable(): void {
  ...
  selection(){
    ...
    this.service.supprimerAvancementsMensuel(dateEffet+"").subscribe((data)=>{
      console.log("les avancements sont supprimeess")
      this.router.navigate(['/updateAvancementMoisMensuel'])
