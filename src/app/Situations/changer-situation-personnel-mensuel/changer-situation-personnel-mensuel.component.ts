...
@Component({
  selector: 'app-changer-situation-personnel-mensuel',
  templateUrl: './changer-situation-personnel-mensuel.component.html',
  styleUrls: ['./changer-situation-personnel-mensuel.component.css']
})
export class ChangerSituationPersonnelMensuelComponent implements OnInit ,AfterViewInit  {
